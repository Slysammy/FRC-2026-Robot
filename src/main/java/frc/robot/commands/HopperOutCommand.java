...
public class HopperOutCommand extends Command {
  ...
  @Override
  public void execute() {
    SmartDashboard.putNumber("Left Encoder Value", hopperSubsystem.leftHopperTravel());
    SmartDashboard.putNumber("Right Encoder Value", hopperSubsystem.rightHopperTravel());
    hopperSubsystem.setLeftMotor(-.31);
    hopperSubsystem.setRightMotor(.3);
    if (RobotContainer.m_hopperSubsystem.leftHopperTravel() == 15 && RobotContainer.m_hopperSubsystem.rightHopperTravel()== 15) {
